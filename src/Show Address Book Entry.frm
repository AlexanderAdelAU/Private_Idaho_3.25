VERSION 5.00
Begin VB.Form frmShowAddressBookEntry 
   Appearance      =   0  'Flat
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   $"Show Address Book Entry.frx":0000
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image1 
      Height          =   660
      Left            =   180
      Picture         =   "Show Address Book Entry.frx":00B8
      Top             =   90
      Width           =   675
   End
   Begin VB.Label Label1 
   ...
   End
End
Attribute VB_Name = "frmShowAddressBookEntry"
...
Set frmShowAddressBookEntry = Nothing
End Sub
